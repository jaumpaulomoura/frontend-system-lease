    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          {/* Espaço para logo - você pode substituir por uma imagem se necessário */}
          <View
            style={{
              height: 50,
              marginVertical: 10,
        ...
        <View style={styles.section}>
          ...
          {/* LOCATÁRIO */}
          <Text style={{ fontWeight: "bold", marginTop: 10, marginBottom: 4 }}>
            LOCATÁRIO:
          </Text>
          <Text>
            <Text style={{ fontWeight: "bold" }}>Nome: </Text>
        ...
        <View
          style={{ borderBottom: "1px solid #000", marginVertical: 10 }}
        ></View>
        {/* Cláusula 2ª */}
        ...
        <Text style={{ fontWeight: "bold" }}> Endereço de entrega: </Text>
        ...
        <Text style={styles.clauseText}>
          <Text style={{ fontWeight: "bold" }}>● No final da locação, </Text>
          <Text>se esta não exceder 30 (trinta) dias; ou</Text>
        </Text>

        <Text style={styles.clauseText}>
          <Text style={{ fontWeight: "bold" }}>● No trigésimo dia, </Text>
